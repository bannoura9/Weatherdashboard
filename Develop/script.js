...
fetch(apiWeather)
    ...
    .then(function (data) {
      ...
      $("#cityName").append("<br/><br/>" + "Temperature: "+data.list[0].main.temp +" F");
      $("#cityName").append("<br/><br/>" + "Humidity: "+data.list[0].main.humidity +"%");
      $("#cityName").append("<br/><br/>" + "Wind Speed: "+data.list[0].wind.speed +" MPH");

      var laT = data.city.coord.lat;
      var loN = data.city.coord.lon;
      var uV = "https://api.openweathermap.org/data/2.5/uvi/forecast?lat="+laT+"&lon="+loN+"&cnt=1&appid="+key;
